...
library(dplyr)
library(stringr)
setwd("/home/durouxd/April/brainCancer/3_singleSource/images/lioness")
...
# Options #
###########
nsel=300 #Number of most variably expressed genes selected
cor_edges=0.75
...
##########################################
data=fread("/home/durouxd/April/brainCancer/0_Data/dataTrainImages.csv")
...
Test=fread("/home/durouxd/April/brainCancer/0_Data/dataTestImages.csv")
